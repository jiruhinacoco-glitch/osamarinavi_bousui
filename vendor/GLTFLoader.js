/* three.js r159 GLTFLoader（examples/jsm を、モジュールなしで読める形に変換したもの・MIT）
   変換内容：import 'three' → window.THREE の分割代入／toTrianglesDrawMode を同梱／export → window へ。
   ★Blenderで書き出した .glb（PBRテクスチャ付き）を読むための部品。ページ本体からは
     3Dで必要になったときだけ <script> で読み込む（nn-rich3d-js の nnLoadGLTF）。 */
(function(){
'use strict';
