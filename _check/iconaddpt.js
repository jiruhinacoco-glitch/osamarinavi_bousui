...
ok((phone?'スマホ':'PC')+' 2枚の画像と頂点追加名',im.every(x=>x.w===1254)&&/btn_addpt\.png\?v=2026-09-15d/.test(im[0].src)&&/btn_sel_point\.png\?v=2026-09-15d/.test(im[1].src)&&(phone?im[0].title.includes('頂点を追加'):im[0].text.includes('頂点追加')),im);
