...
ok(css.includes('orientation:portrait')&&css.includes('grid-template-columns:repeat(10')&&css.includes('grid-column:span 2')&&css.includes('grid-column:2 / span 2'), 'スマホ縦画面の下部ナビを上5個・下4個中央に配置');
