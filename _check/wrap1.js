...
/* ★2026-09-09 §359 道は「防水層の面」をなぞるようになった（GPTの指摘②）。
   防水層は 天端＝12mm・立上り＝6mm 手前なので、面取りの斜面は躯体の45度ちょうどではなく
   Δt=-(CH+0.006)／Δy=(CH+0.012) の傾き（CH=20mmで約51度）になるのが正しい。 */
ok(R.ns.some(v=>near(v[1],0.63,0.10)&&near(v[2],0.78,0.10)), '② 面取りの斜面（防水層の面・約51度）がある');
