...
function addHoleStamps(){
  if(typeof NN_STAMPS==='undefined')return false;var ph=window.NN_DRAIN_PHI||[50,75,100,125,150,175,200];ph.forEach(function(f){NN_STAMPS['floorhole'+f]={name:'床のドレン穴 '+f+'φ',kind:'hole',w:f,d:f,h:30,price:0,addM2:0,sealM:0,memo:'躯体開口のみ'};NN_STAMPS['wallhole'+f]={name:'壁のドレン穴 '+f+'φ',kind:'hole',w:f,d:30,h:f,price:0,addM2:0,sealM:0,memo:'躯体開口のみ'};});return true;
}
